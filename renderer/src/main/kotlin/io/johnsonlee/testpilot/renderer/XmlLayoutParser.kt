...
/**
 * XML layout parser for layoutlib rendering.
 */
class XmlLayoutParser private constructor(
    ...
    // Delegate XmlPullParser methods to the underlying parser
    ...
    companion object {
         ...
         */
        fun fromString(xml: String): XmlLayoutParser {
            val parser = KXmlParser().apply {
                setFeature(XmlPullParser.FEATURE_PROCESS_NAMESPACES, true)
                setInput(StringReader(xml))
            }
            return XmlLayoutParser(parser)
        }
    }
}
