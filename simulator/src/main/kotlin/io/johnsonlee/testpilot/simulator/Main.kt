...
fun main(args: Array<String>) {
    ...
    try {
        ...
        // Step 4: Parse AndroidManifest.xml
        if (contents.manifest != null) {
            println("[4] Parsing AndroidManifest.xml...")
            try {
        ...
        // Step 5: Parse resources.arsc
        if (contents.resources != null) {
            println("[5] Parsing resources.arsc...")
            try {
        ...
        println("=".repeat(60))
        println("TestPilot APK Loading Complete!")
        println("=".repeat(60))
